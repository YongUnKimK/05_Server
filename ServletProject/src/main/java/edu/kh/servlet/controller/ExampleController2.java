...
public class ExampleController2 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// -> tomcat 10버전 이상부터 자동으로 인코딩 처리를 해주기때문에
		...
		// 응답화면 만들기
		// -> Java에서 응답화면을 작성하기 번거롭다
		// -> Jsp가 대신 화면을 만든다 ( Servlet이 JSP에게 요청을 위임함
		
		// JSP가 대신 응답 화면을 만들기 위해서는
		// Servlet이 어떤 요청을 받았는지 알아야한다! ( req, resp 필요 )
		...
		// RequestDispatcher 객체를 사용하여 현재 요청과 응답 (req, resp) 를
